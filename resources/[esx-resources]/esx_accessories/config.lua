...
Config.ShopsBlips = {
	...
	Mask = {
		Pos = { 
			vector3(125.18, -224.93, 53.75),
			vector3(-1192.68, -767.68, 16.50),
			vector3(75.48,  -1393.9, 28.38),
			vector3(-163.76, -303.98, 38.73),
			vector3(-823.06, -1074.07, 10.33),
			vector3(-1449.75, -236.779, 48.81),
			vector3(5.31, 6512.99, 30.88),
			vector3(1693.75, -4823.23, 41.06),
			vector3(614.2, 2764.0, 41.09),
			vector3(-3171.02, 1042.83, 19.86),
			vector3(-1101.93, 2710.05, 18.11),
			vector3(425.52, -805.58, 28.49),
