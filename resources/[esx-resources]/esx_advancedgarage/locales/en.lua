Locales['en'] = {
	...
	['blip_garage'] = 'Garage',
	['blip_boatgarage'] = 'Boat Garage',
	['blip_garage_private'] = 'Private Garage',
	['blip_pound'] = 'Impound Lot',
	['blip_police_pound'] = 'Police Impound',
	['blip_ambulance_pound'] = 'Ambulance Impound',
	['garage'] = 'Garage',
	['loc_garage'] = 'Parked in Garage',
	['loc_pound'] = 'At the Impound',
	['return'] = 'Return',
	['store_vehicles'] = 'Store Vehicle in Garage.',
	['press_to_enter'] = 'Press ~INPUT_PICKUP~ to access the ~g~Garage.~s~',
	['press_to_delete'] = 'Press ~INPUT_PICKUP~ to store your vehicle in the ~r~Garage.~s~',
	['press_to_impound'] = 'Press ~INPUT_PICKUP~ to access the ~o~Impound~s~.',
	...
	-- Jobs
	['pound_police'] = 'Police Impound',
	['pound_ambulance'] = 'Ambulance Impound',
