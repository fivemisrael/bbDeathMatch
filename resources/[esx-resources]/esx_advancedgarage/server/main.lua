...
AddEventHandler('esx_advancedgarage:payAircraft', function()
	...
	TriggerClientEvent('notification', source, 'You paid $'..Config.AircraftPoundPrice)
...
AddEventHandler('esx_advancedgarage:payBoat', function()
	...
	TriggerClientEvent('notification', source, 'You paid $'..Config.BoatPoundPrice)
...
AddEventHandler('esx_advancedgarage:payCar', function()
	...
	TriggerClientEvent('notification', source, 'You paid $'..Config.CarPoundPrice)
...
AddEventHandler('esx_advancedgarage:payPolicing', function()
	...
	TriggerClientEvent('notification', source, 'You paid $'..Config.PolicingPoundPrice)
...
AddEventHandler('esx_advancedgarage:payAmbulance', function()
	...
	TriggerClientEvent('notification', source, 'You paid $'..Config.AmbulancePoundPrice)
...
AddEventHandler('esx_advancedgarage:payhealth', function(price)
	...
	TriggerClientEvent('notification', source, 'You paid $'..price)
