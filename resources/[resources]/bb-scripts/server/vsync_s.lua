...
admins = {
    'steam:110000107c9bc84', -- Twiztid
    'steam:110000119f6d64d', -- BarBaroNN
    'steam:11000011b4bfcd2', -- Ricko
    'steam:110000134fd0ca8', -- Praise
    'steam:110000116fba84d', -- Senor
    'steam:11000010447fe3e', -- BM
}

-- Set this to false if you don't want the weather to change automatically every 60 minutes.
...
RegisterCommand('timechange', function(source, args, rawCommand)
    if source == 0 then
...
function NextWeatherStage()
    if CurrentWeather == "CLEAR" or CurrentWeather == "FOGGY" or CurrentWeather == "EXTRASUNNY"  then
