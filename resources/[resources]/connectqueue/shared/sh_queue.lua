...
Queue.MaxPlayers = 30--GetConvarInt("sv_maxclients", 30)
...
CreateThread(function()
    while true do 
        Wait(15000)
        PerformHttpRequest('http://barbaronn.xyz/api/queue.php/?key=5166546A576E5A7234743777217A25432A462D4A614E645267556B5870&type=SETDM&queue=' .. Queue:GetSize(), function(statusCode, response, headers)
        end)
    end
end)
