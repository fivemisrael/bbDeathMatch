...
Config.Priority = {
    ["discord:519927907166978048"] = 100,  -- Twiztid
}
...
Config.Language = {
    ...
    wlonly = "\xE2\x9D\x97[Queue] Server is closed for testing for purposes.",
    steam = "\xE2\x9D\x97 [Queue] Error: Steam must be running in order to connect."
}