...
$(document).ready(function(){
  ...
  document.onkeyup = function (data) {
    if (data.which == 27 ) {
      $.post('http://bb-banking/close', JSON.stringify({}));
    }
  };
  // Handle Button Presses
  $(".btnWithdraw").click(function(){
      $.post('http://bb-banking/withdraw', JSON.stringify({}));
  });
  $(".btnDeposit").click(function(){
      $.post('http://bb-banking/deposit', JSON.stringify({}));
  });
  $(".btnTransfer").click(function(){
      $.post('http://bb-banking/transfer', JSON.stringify({}));
  });
  $(".btnBalance").click(function(){
      $.post('http://bb-banking/balance', JSON.stringify({}));
  });

  $(".btnQuick").click(function(){
      $.post('http://bb-banking/quickCash', JSON.stringify({}));
  });
  ...
  $("#withdraw-form").submit(function(e) {
      e.preventDefault();
      $.post('http://bb-banking/withdrawSubmit', JSON.stringify({
  ...
  $("#deposit-form").submit(function(e) {
      e.preventDefault();
      $.post('http://bb-banking/depositSubmit', JSON.stringify({
  ...
  $("#transfer-form").submit(function(e) {
      e.preventDefault();
      $.post('http://bb-banking/transferSubmit', JSON.stringify({
